...
<div id="application">
		...
		<div class="flex px-24 mt-4 py-4 justify-between">
			...
			<div class="inline-flex">
				<span class="font-body font-bold tracking-wider text-gray-700"> Application</span>
			</div>

				<div class="inline-flex">
				<span class="font-body font-bold tracking-wider text-gray-700">My Application</span>
			</div>
