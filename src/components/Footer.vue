...
<div id="footer" class="bg-white p-4 hidden py-4 lg:block">
 ...
 <!--  The Footer Section -->
        ...
        <div class="flex justify-between items-center px-2 py-1 position-bottom">

          <div class="lg:block ">

            <a class="block inline-flex rounded-lg px-3 py-2 hover:bg-purple-200 hover:text-purple-600">  <img src="/img/logo2.svg" class="h-3 w-3"/> <span class="font-body font-extrabold uppercase cursor-pointer text-gray-800 ml-2 text-xs"> Resume.ly</span></a>
          ...
          <div class="hidden lg:block">
            ...
            <a href="" class="block font-ordinary text-gray-800 rounded-lg px-3 py-2 tracking-wider hover:bg-purple-200 hover:text-purple-600 font-body text-sm" > Introduction</a>
            <a href="" class=" font-body block font-ordinary text-gray-800 rounded-lg px-3 py-2 tracking-wider hover:bg-purple-200 hover:text-purple-600 text-sm ">Help Center</a>
          </div>
          <div class=" hidden lg:block">
          ...
          <div class="">
            ...
            <a href="" class="block px-3 py-2">  <img src="/img/googleplay.svg" class=" h-4 w-4 text-gray"></a>
            <a href="" class="block px-3 py-2">  <img src="/img/appstore.svg" class="h-4 w-4"></a>
