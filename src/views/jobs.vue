...
<!-- The navbar -->
  ...
  <header class="flex flex-shrink-0">
    <div class="flex-shrink-0 px-4 py-3 bg-gray-200 lg:w-64 lg:bg-gray-800">
      <button
    ...
    <div
      class="flex-1 flex items-center justify-between pl-2 pr-6 bg-white lg:px-6 shadow"
    >
      <nav class="hidden sm:flex">
        <a
          href="#"
          class="inline-block px-3 py-2 bg-gray-900 rounded-lg leading-none text-sm font-medium text-gray-700"
        >
          Mailbox
        </a>
        <a
          href="#"
          class="ml-2 inline-block px-3 py-2 rounded-lg leading-none text-sm font-medium text-gray-700 hover:bg-gray-600"
        >
          Customers
        </a>
        <a
      ...
      <div class="ml-auto flex items-center">
        ...
        <div class="hidden lg:block relative w-64">
          ...
          <input
            class="block pl-9 pr-4 py-2 w-full bg-gray-400 rounded-lg text-sm placeholder-gray-300 text-grey-300 focus:bg-white focus:placeholder-gray-600 focus:text-gray-900 focus:outline-none"
            placeholder=""
          />
        </div>
        <button class="ml-5 text-gray-700 hover:text-gray-700">
          <svg class="h-5 w-5 fill-current" viewBox="0 0 24 24">
            <path
        ...
        <button class="ml-4 text-gray-700 hover:text-gray-700">
          <svg class="h-5 w-5 fill-current" viewBox="0 0 24 24">
...
<!-- slidenav -->
  ...
  <div class="flex-1 flex overflow-hidden">
    <div
      :class="sidebarOpen ? 'translate-x-0 ease-out transition-slow' : '-translate-x-full ease-in transition-medium'"
