      ...
      <div class="max-w-md w-full ">
        <div class="">
          ...
          <p class="mt-2 text-center font-body text-sm leading-5 text-gray-800 font-extrabold">
            Or
            <router-link to="/register" class="font-bold font-body tracking-wider bg-clip-text text-purple-600 focus:outline-none focus:underline transition ease-in-out duration-150">
              create new account
            </router-link>
          </p>
        </div>
