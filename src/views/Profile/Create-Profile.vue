...
<div class="flex items-center justify-center bg-transparent py-12 px-4 mx-auto sm:px-6 lg:px-8 ">
    <div class="max-w-md w-full">
      <div>
        ...
        <img src="/img/examples.jpg" class="mx-auto h-16 w-16 mt-8 rounded-full object-cover object-center">
    ...
    <form class="mt-8" action="">
        ...
        username*
          ...
          <input aria-label="text" name="text" type="text" required class="appearance-none rounded-none  block w-full px-3 py-2 border border-gray-400 placeholder-gray-500 text-gray-900 rounded-md shadow focus:outline-none focus:shadow-outline focus:z-10 sm:text-sm sm:leading-5" placeholder="" />
        </div>
